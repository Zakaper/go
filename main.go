...
type InfoMessage struct {
	...
	TrsaningType string        // тип тренировки
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier*Weight + (math.Pow(meanSpeed, 2)/Height)*CaloriesSpeedHeightMultiplier*Weight) * Duration * MinInHours)
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	(s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * Weight * Duration
}
